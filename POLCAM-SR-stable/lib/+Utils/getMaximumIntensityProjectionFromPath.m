function projection = getMaximumIntensityProjectionFromPath(filepath)
% GETMAXIMUMINTENSITYPROJECTIONFROMPATH
...
if tr.lastDirectory()
    ...
    while true % read remaining frames
        projection = max(cat(3,projection,double(tr.read())),[],3);
